 ...
 /*
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("nl.bsoft.monitoring.insuranceservice.controller")).build()
                .apiInfo(metaData());
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Bart van Pelt", "https://github.com/bvpelt", "brtvnplt@gmail.com"))
                .build();
    }
